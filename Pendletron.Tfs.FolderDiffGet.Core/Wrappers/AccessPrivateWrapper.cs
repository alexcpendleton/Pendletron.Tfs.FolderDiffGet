...
namespace Pendletron.Tfs.FolderDiffGet.Core.Wrappers
{
	...
	public class AccessPrivateWrapper : DynamicObject
	{
		...
		public static BindingFlags flags = BindingFlags.NonPublic | BindingFlags.Instance
			| BindingFlags.Static | BindingFlags.Public | BindingFlags.Default;
		...
		public static dynamic FromType(Assembly asm, string type, params object[] args)
		{
			...
			var t = allt.First(item => item.FullName.Equals(type, StringComparison.InvariantCultureIgnoreCase));
